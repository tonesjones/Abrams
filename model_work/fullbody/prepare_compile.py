...
for kind, image in [('body', 'Image_0.png'), ('eyes', 'Image_2.png')]:
    ...
    normal = '[0.5 0.5 1.0 0.0]'
    if kind == 'body':
        shutil.copyfile(HERE.parent / 'import_head/textures/Image_1.png', MATERIALS / (name + '_normal.png'))
        normal = f'models/heroes_wip/abrams/materials/{name}_normal.png'
    material = f'''"Layer0"
{{
    "shader" "pbr.vfx"
