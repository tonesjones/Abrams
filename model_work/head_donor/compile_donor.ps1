...
$source = Join-Path $sdk 'content\citadel_addons\sulley_head_donor\models\heroes_wip\abrams\sulley_donor.vmdl'
$output = Join-Path $sdk 'game\citadel_addons\sulley_head_donor\models\heroes_wip\abrams\sulley_donor.vmdl_c'
